...
public class Resource {
	...
	public final static String[] soldierNameUp = { "步兵", "剑士", "近卫军", "骑兵",
			"骑士", "金甲骑卫", "猎人", "弓箭手", "游侠", "锤兵", "铁锤兵", "钢铁守卫", "牧师", "神官",
	...
	public static String[] AttainmentCondition = { "完成新手指导。", "击败索米亚草原的boss1",
			...
			"击败冰霜大陆的boss2", "击败熔岩之岛的boss1", "击败熔岩之岛的boss2", "通天塔第10层取得胜利",
			"通天塔第20层取得胜利", "通天塔第30层取得胜利", "通天塔第40层取得胜利", "索米亚草原的所有关卡取得3星",
			"怨灵地窟的所有关卡取得3星", "冰霜大陆的所有关卡取得3星", "熔岩之岛的所有关卡取得3星", "英雄1升到20级",
			"英雄2升到20级", "英雄3升到20级", "英雄4升到20级", "英雄5升到20级", "英雄6升到20级",
			"步兵升到20级", "骑士升到20级", "猎人升到20级", "锤兵升到20级", "牧师升到20级", "狂战士升到20级",
			"魔法兵升到20级", "刺客升到20级", "火枪兵升到20级" };
	...
	static String[] somePic = { "/common/1.png", "/common/2.png",
			...
			"/secondpage/soldier122.png", "/secondpage/xingyunchoujiang.png",
