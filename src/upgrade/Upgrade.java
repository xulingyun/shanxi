...
public class Upgrade {
	...
	public static int upgradeMonsterBoold(int initBoold, int guanqia,
			int baseNumBoold, boolean fangshi, int tong40) {
		int blood;
		if (!fangshi)
	...
	public static int upgradeMonsterAtk(int initAtk, int guanqia,
			int baseNumAtk, boolean fangshi, int tong40) {
		int Atk;
		if (!fangshi)
	...
	public static long TguanqiaMoney(int guanqiaIndex, int tong40) {
		long money;
		if (tong40 == 0) {
			money = Resource.TongMoneyAndJingyan[0]
					+ Resource.TongMoneyAndJingyan[1] * guanqiaIndex;
		} else {
			money = Resource.TongMoneyAndJingyan[0] * 2
					+ Resource.TongMoneyAndJingyan[1] * (guanqiaIndex + 40);
		}
		return money;
	}
	...
	public static long TguanqiaExp(int guanqiaIndex, int tong40) {
		long Exp;
		if (tong40 == 0) {
			Exp = Resource.TongMoneyAndJingyan[2]
					+ Resource.TongMoneyAndJingyan[3] * guanqiaIndex;
		} else {
			Exp = Resource.TongMoneyAndJingyan[2] * 2
					+ Resource.TongMoneyAndJingyan[3] * (guanqiaIndex + 40);
		}
		return Exp;
	}
